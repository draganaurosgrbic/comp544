...
public class ListTest extends TestCase {
  ...
  public void testInsert() {
    ...
    ConsList<Map<Integer,Integer>> notComparableList = new EmptyList<Map<Integer,Integer>>().cons(Map.of(1,1)).cons(Map.of(2,2));
    //assertEquals("test T not Comparable", notComparableList, notComparableList.insert(1));
    //assertEquals("test T not Comparable", notComparableList, notComparableList.insert(2));
    //assertEquals("test T not Comparable", notComparableList, notComparableList.insert(3));
  }
  ...
  public void testInsertVisitor() {
    ...
    ConsList<Map<Integer,Integer>> notComparableList = new EmptyList<Map<Integer,Integer>>().cons(Map.of(1,1)).cons(Map.of(2,2));
    //assertEquals("test T not Comparable", notComparableList, notComparableList.visit2(new InsertVisitor<>(1)));
    //assertEquals("test T not Comparable", notComparableList, notComparableList.visit2(new InsertVisitor<>(2)));
    //assertEquals("test T not Comparable", notComparableList, notComparableList.visit2(new InsertVisitor<>(3)));
  }
  ...
  public void testInsertSort() {
    ...
    ConsList<Map<Integer,Integer>> notComparableList = new EmptyList<Map<Integer,Integer>>().cons(Map.of(1,1)).cons(Map.of(2,2));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(3,3)), notComparableList.insertSort());
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(4,4)), notComparableList.insertSort());
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(5,5)), notComparableList.insertSort());
  }
  ...
  public void testInsertSortVisitor() {
    ...
    ConsList<Map<Integer,Integer>> notComparableList = new EmptyList<Map<Integer,Integer>>().cons(Map.of(1,1)).cons(Map.of(2,2));
    //assertEquals("test T not Comparable", notComparableList, notComparableList.cons(Map.of(3,3)).visit2(new InsertSortVisitor<Integer>()));
    //assertEquals("test T not Comparable", notComparableList, notComparableList.cons(Map.of(4,4)).visit2(new InsertSortVisitor<Integer>()));
    //assertEquals("test T not Comparable", notComparableList, notComparableList.cons(Map.of(5,5)).visit2(new InsertSortVisitor<Integer>()));
  }
  ...
  public void testMergeHelp() {
    ...
    ConsList<Map<Integer,Integer>> notComparableList = new EmptyList<Map<Integer,Integer>>().cons(Map.of(1,1)).cons(Map.of(2,2));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(3,3)), notComparableList.mergeHelp(l0));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(4,4)), notComparableList.mergeHelp(l0));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(5,5)), notComparableList.mergeHelp(l0));
  }
  ...
  public void testMergeHelpVisitor() {
    ...
    ConsList<Map<Integer,Integer>> notComparableList = new EmptyList<Map<Integer,Integer>>().cons(Map.of(1,1)).cons(Map.of(2,2));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(3,3)), notComparableList.visit2(new MergeHelpVisitor<>(l0)));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(4,4)), notComparableList.visit2(new MergeHelpVisitor<>(l0)));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(5,5)), notComparableList.visit2(new MergeHelpVisitor<>(l0)));
  }
  ...
  public void testMerge() {
    ...
    ConsList<Map<Integer,Integer>> notComparableList = new EmptyList<Map<Integer,Integer>>().cons(Map.of(1,1)).cons(Map.of(2,2));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(3,3)), notComparableList.merge(l0));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(4,4)), notComparableList.merge(l0));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(5,5)), notComparableList.merge(l0));
  }
  ...
  public void testMergeVisitor() {
    ...
    ConsList<Map<Integer,Integer>> notComparableList = new EmptyList<Map<Integer,Integer>>().cons(Map.of(1,1)).cons(Map.of(2,2));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(3,3)), notComparableList.visit2(new MergeVisitor<>(l0)));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(4,4)), notComparableList.visit2(new MergeVisitor<>(l0)));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(5,5)), notComparableList.visit2(new MergeVisitor<>(l0)));
  }
  ...
  public void testMergeSort() {
    ...
    ConsList<Map<Integer,Integer>> notComparableList = new EmptyList<Map<Integer,Integer>>().cons(Map.of(1,1)).cons(Map.of(2,2));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(3,3)), notComparableList.mergeSort());
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(4,4)), notComparableList.mergeSort());
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(5,5)), notComparableList.mergeSort());
  }
  ...
  public void testMergeSortVisitor() {
    ...
    ConsList<Map<Integer,Integer>> notComparableList = new EmptyList<Map<Integer,Integer>>().cons(Map.of(1,1)).cons(Map.of(2,2));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(3,3)), notComparableList.visit2(new MergeSortVisitor<Integer>()));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(4,4)), notComparableList.visit2(new MergeSortVisitor<Integer>()));
    //assertEquals("test T not Comparable", notComparableList.cons(Map.of(5,5)), notComparableList.visit2(new MergeSortVisitor<Integer>()));
  }
